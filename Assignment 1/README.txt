...
directory, and are provided for 64 bit Windows (10 / 11).
...
- BOTH students' full names, cs us  ernames, and student numbers
...
In this assignment, you will be writing a C++/SFML Prgram which will read
...
of the window, its X speed reverses. If hte toip of the shape hits the top of the
...
Rectangle N X Y SX SY R G B WH 
...
- A shape will 'touch' the side of the window if its bounding box makes
  ...
  that has been applied to the shape. Maybe useful for the ui scaling
...
- Please use C++ file reading (std::ifstream makes this easy) rather
  than C-style FILE reading. You will use marks for using older C functions!